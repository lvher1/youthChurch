...
class _Schedule extends State<Schedule> {
  ...
  Future getPeriod() async {
    DateTime? firstDay = await showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime(2000), lastDate: DateTime(2200));
    DateTime? lastDay = await showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime(2000), lastDate: DateTime(2200));
    setState(() {
      _first = firstDay;
      _last = lastDay;
    });
